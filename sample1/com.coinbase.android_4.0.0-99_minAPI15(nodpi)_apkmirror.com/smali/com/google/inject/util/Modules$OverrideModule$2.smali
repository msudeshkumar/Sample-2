...
.method rewrite(Lcom/google/inject/Binder;Lcom/google/inject/spi/PrivateElements;Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v3, v0, v4}, Lcom/google/inject/util/Modules$OverrideModule$2;->rewrite(Lcom/google/inject/Binder;Lcom/google/inject/spi/PrivateElements;Ljava/util/Set;)V
...
.method public visit(Lcom/google/inject/Binding;)Ljava/lang/Void;
    ...
    iget-object v2, p0, Lcom/google/inject/util/Modules$OverrideModule$2;->val$overriddenKeys:Ljava/util/Set;
    ...
    .line 229
    iget-object v2, p0, Lcom/google/inject/util/Modules$OverrideModule$2;->this$0:Lcom/google/inject/util/Modules$OverrideModule;

    # invokes: Lcom/google/inject/util/Modules$OverrideModule;->getScopeInstanceOrNull(Lcom/google/inject/Binding;)Lcom/google/inject/Scope;
    invoke-static {v2, p1}, Lcom/google/inject/util/Modules$OverrideModule;->access$200(Lcom/google/inject/util/Modules$OverrideModule;Lcom/google/inject/Binding;)Lcom/google/inject/Scope;

    move-result-object v1

    .line 230
    .local v1, "scope":Lcom/google/inject/Scope;
    if-eqz v1, :cond_1
    ...
    .line 232
    .local v0, "existing":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    if-nez v0, :cond_0
    ...
    .line 240
    .end local v0    # "existing":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    .end local v1    # "scope":Lcom/google/inject/Scope;
    :cond_1
    const/4 v2, 0x0
