...
.method public static getAuthCode(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "Unexpected response from Google Now app"
    ...
    const-string v6, "Call to Google Now app failed"
    ...
    .line 92
    const-string v5, "NowAuthService"
    ...
    const-string v7, "Unexpected error from Google Now app: "
    ...
    const-string v6, "Interrupted while contacting Google Now app"
    ...
    const-string v6, "next-retry-timestamp-millis"
    ...
    const-string v6, "Failed to contact Google Now app"
